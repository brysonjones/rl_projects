...
class Memory():
    def __init__(self, max_length=1000):
        ...
        self.new_state_list = deque(maxlen=max_length)
        self.prev_state_list = deque(maxlen=max_length)
        self.action_list = deque(maxlen=max_length)
        self.reward_list = deque(maxlen=max_length)
        self.done_state_list = deque(maxlen=max_length)
    ...
    def get_samples(self, sample_size):
        ...
        for i in range(sample_size):
            sample_idx = random.randint(0, len(self.new_state_list))
